...
/**
 * Normalize Directory
 * Creates an object with more details on the file path
 * @param  {Object|String} dir An Object that contains the file's source path, or a string of the file's source path, usually a relative path
 * @param  {String} cwd A string of the current working directory path
 * @returns {Object}     An object that contains the file's source path at 'src', and any options that might be needed when the file is gobbed at 'options'
 */
