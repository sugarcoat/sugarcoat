...
function init( options ) {
    ...
    if ( !_.isEqual( template.helpers, defaults.template.helpers ) && _.isEqual( template.partials, defaults.template.partials ) && _.isEqual( template.layout, defaults.template.layout ) ) {
