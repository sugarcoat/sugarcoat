...
Parser.prototype = {
    ...
    /**
     * Parse Comment
     * Uses comment serializer to parse the file for it's comments
     ...
     * @returns {Object}              The Data object that includes each comment blocks info like each tag's info withn the doc block, see comment serializer
     */
     ...
     * @returns {Array}      Array of objects that includes the variables and their values
     */
